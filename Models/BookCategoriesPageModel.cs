...
namespace Uifalean_Emanuel_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Uifalean_Emanuel_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Uifalean_Emanuel_Lab2Context context,
