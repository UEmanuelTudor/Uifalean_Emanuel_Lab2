...
namespace Uifalean_Emanuel_Lab2.Data
{
    public class Uifalean_Emanuel_Lab2Context : DbContext
    {
        ...
        public DbSet<Uifalean_Emanuel_Lab2.Models.Author> Author { get; set; }

        public DbSet<Uifalean_Emanuel_Lab2.Models.Category> Category { get; set; }

        public DbSet<Uifalean_Emanuel_Lab2.Models.Member> Member { get; set; }

        public DbSet<Uifalean_Emanuel_Lab2.Models.Borrowing> Borrowing { get; set; }
    }
}
